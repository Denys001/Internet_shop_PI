...
<div class="container mt-3">
    <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{ old('name') ? old('name') : $product->name  }}" require placeholder="Enter Products name">
            @error('name')
        ...
        <div class="form-group">
            ...
            <textarea type="password" class="form-control @error('text') is-invalid @enderror" name="text" id="text" placeholder="Description">{{ old('text') ? old('text') : $product->description  }}</textarea>
            @error('text')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="number" class="form-control @error('price') is-invalid @enderror" step='0.01' min="0.00" max="99999.99" name="price" id="price" placeholder="Price" value="{{ old('price') ? old('price') : $product->price  }}">
            </div>
            @error('price')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
